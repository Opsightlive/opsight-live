...
const PropertyPaymentSetup: React.FC<PropertyPaymentSetupProps> = ({ onComplete }) => {
  ...
  const pricingTiers = [
    { id: 'basic', name: 'Basic', price: 3, color: 'blue' },
    { id: 'professional', name: 'Professional', price: 4, color: 'green' },
    { id: 'enterprise', name: 'Enterprise', price: 5, color: 'purple' }
  ];
  ...
  const monthlyTotal = selectedTierData ? totalUnits * selectedTierData.price : 0;
  ...
  const discountAmount = hasAllCardPayments && selectedTier ? Math.round(monthlyTotal * creditCardDiscount) : 0;
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-6 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl text-blue-100 max-w-3xl">
                Select your pricing tier and configure payment for your {properties.length} {properties.length === 1 ? 'property' : 'properties'}
              </p>
        ...
        <div className="space-y-4">
          <h3 className="text-2xl font-bold text-gray-900">1. Select Your Pricing Tier</h3>
          <div className="grid md:grid-cols-3 gap-6">
            {pricingTiers.map((tier) => {
              const isSelected = selectedTier === tier.id;
              const totalCost = totalUnits * tier.price;
              ...
              return (
                <Card 
                  ...
                  className={`cursor-pointer transition-all duration-200 ${
                    isSelected 
                      ? `border-2 border-${tier.color}-600 shadow-lg ring-2 ring-${tier.color}-100` 
                  ...
                  <CardHeader className="text-center">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-baseline justify-center">
                        ...
                        <span className="text-gray-500 ml-1">/unit/month</span>
                      </div>
                  ...
                  <CardContent>
                    <div className="text-center">
                      <Button 
                        ...
                        className={`w-full ${isSelected ? `bg-${tier.color}-600 hover:bg-${tier.color}-700` : ''}`}
                        onClick={(e) => {
                          e.stopPropagation();
        ...
        {/* Payment Methods Section - Only show if tier is selected */}
        {selectedTier && (
                ...
                <div className="text-center">
                  ...
                  <div className="bg-white rounded-lg p-4 text-left">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-semibold">{selectedTierData?.name} (${selectedTierData?.price}/unit)</span>
                    </div>
                    <div className="flex justify-between items-center mb-2">

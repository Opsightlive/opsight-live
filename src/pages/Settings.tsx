        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <Label htmlFor="aiReaderMode">Upload Mode</Label>
                  <Select value={settings.aiReaderMode} onValueChange={(value) => handleSettingChange('aiReaderMode', value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="automatic">Automatic Upload</SelectItem>
                      <SelectItem value="manual">Manual Upload</SelectItem>
                    </SelectContent>
                  </Select>
                  <p className="text-sm text-gray-500 mt-1">
                    {settings.aiReaderMode === 'automatic' 
                      ? 'Documents will be automatically uploaded and processed' 
                      : 'You will manually upload documents for processing'}
                  </p>
                </div>
              </CardContent>
            </Card>

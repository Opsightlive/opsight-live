  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Predictive Signals</h1>
          <p className="text-gray-600 mt-2">AI-powered insights to anticipate portfolio performance</p>
        </div>

...
import { AlertTriangle, Filter, Clock, Send, CheckCircle, Calendar, Plus, Eye, UserPlus, TrendingUp, TrendingDown } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 text-white p-8 rounded-lg shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl text-red-100 max-w-3xl">Monitor and resolve critical performance alerts across all properties with real-time insights and automated notifications</p>
              <div className="flex items-center gap-6 mt-4">
                <div className="flex items-center gap-2">
                  <AlertTriangle className="h-5 w-5" />
                  <span>{filteredAlerts.length} Active Alerts</span>
                </div>
                <div className="flex items-center gap-2">
                  <TrendingUp className="h-5 w-5" />
                  <span>{forecastedAlerts.length} Forecasted</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5" />
                  <span>{resolvedAlerts.size} Resolved Today</span>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white border border-gray-200 p-6 mb-8 rounded-lg shadow-sm">
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3">
              <label className="text-base font-medium text-black">Severity:</label>
              <select 
        ...
        <Tabs defaultValue="active" className="space-y-6">
          <TabsList>
            <TabsTrigger value="active">Active Red Flags ({filteredAlerts.length})</TabsTrigger>
            <TabsTrigger value="forecasted">Forecasted Alerts ({forecastedAlerts.length})</TabsTrigger>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {filteredAlerts.map((alert) => (
                <div key={alert.id} className="space-y-4">
                  <div className={`border-2 p-6 rounded-lg ${getSeverityColor(alert.severity)} ${resolvedAlerts.has(alert.id) ? 'opacity-50' : ''}`}>
                    ...
                    <div className="bg-white p-3 mb-4 border border-gray-200 rounded">
                    ...
                    <div className="flex space-x-2 mb-4">
                      <button 
                        ...
                        className="flex-1 bg-blue-600 text-white py-2 px-4 text-sm font-medium hover:bg-blue-700 rounded flex items-center justify-center"
                      ...
                      <button 
                        ...
                        className="flex-1 bg-purple-600 text-white py-2 px-4 text-sm font-medium hover:bg-purple-700 rounded flex items-center justify-center"
                        disabled={resolvedAlerts.has(alert.id)}
                      >
                      ...
                      <button 
                        ...
                        className="flex-1 bg-green-600 text-white py-2 px-4 text-sm font-medium hover:bg-green-700 rounded flex items-center justify-center"
                        disabled={resolvedAlerts.has(alert.id)}
                      >
                    ...
                    <div className="flex space-x-2 mb-4">
                      <button
                        ...
                        className="flex-1 bg-gray-600 text-white py-2 px-4 text-sm font-medium hover:bg-gray-700 rounded flex items-center justify-center"
                      >
          ...
          <TabsContent value="forecasted">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {forecastedAlerts.map((alert) => (
                <div key={alert.id} className="bg-blue-50 border-2 border-blue-200 p-6 rounded-lg">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center">
                  ...
                  <div className="bg-blue-100 p-3 mb-4 border border-blue-200 rounded">
                  ...
                  <div className="flex space-x-2">
                    <button 
                      ...
                      className="flex-1 bg-blue-600 text-white py-2 px-4 text-sm font-medium hover:bg-blue-700 rounded"
                    >
                      Create Action Plan
                    </button>
                    <button 
                      onClick={() => handleMonitorAlert(alert)}
                      className="flex-1 bg-gray-600 text-white py-2 px-4 text-sm font-medium hover:bg-gray-700 rounded"
                    >
                      Monitor
                    </button>
                  </div>
          ...
          <TabsContent value="timeline">
            <div className="bg-white p-6 rounded-lg border">
              <h3 className="text-lg font-semibold mb-4">Alert Timeline View</h3>
              <p className="text-gray-600">Timeline functionality will be available soon. This will show the chronological history of all alerts.</p>
            </div>
          </TabsContent>
        </Tabs>

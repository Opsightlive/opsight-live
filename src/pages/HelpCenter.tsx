...
const HelpCenter = () => {
  ...
  const popularTopics = [
    { icon: FileText, title: 'Getting Started Guide', desc: 'Learn the basics of OpSight' },
    { icon: Users, title: 'User Management', desc: 'Managing team members and permissions' },
    { icon: Settings, title: 'Account Settings', desc: 'Configure your account preferences' },
    { icon: AlertCircle, title: 'Red Flag Alerts', desc: 'Understanding and managing alerts' },
    { icon: MessageCircle, title: 'AI Reader Setup', desc: 'Configuring automatic report processing' },
    { icon: CheckCircle, title: 'KPI Dashboard', desc: 'Customizing your performance metrics' }
  ];
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">1-800-OPSIGHT</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">support@opsight.com</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">

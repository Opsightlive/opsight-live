        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/company" className="text-gray-600 hover:text-gray-900">Company</a>
              ...
              <Link to="/login" className="text-gray-600 hover:text-gray-900">Sign In</a>
              <Link to="/signup">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-gray-200">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <Link to="/company" className="block px-3 py-2 text-gray-600 hover:text-gray-900">Company</a>
                ...
                <Link to="/login" className="block px-3 py-2 text-gray-600 hover:text-gray-900">Sign In</a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link to="/company" className="hover:text-white">About</a></li>

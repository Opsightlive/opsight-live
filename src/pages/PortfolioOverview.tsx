        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-8 rounded-lg shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl text-blue-100 max-w-3xl">Manage and monitor all your properties with comprehensive insights and analytics</p>
            </div>
            <Button onClick={handleAddProperty} className="bg-white text-blue-600 hover:bg-blue-50">
